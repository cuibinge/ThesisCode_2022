...
class SeafogDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        spixel = np.asarray(imageio.imread(os.path.join(self.data_root,self.split, 'superpixel', name+'.png')))
        ...
        return {'name': name, 'img': img, 'spixel': spixel}
...
class SeafogClassificationPairDataset(SeafogDataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.ids[idx][1] == '1':
            ...
            pair_outs['pos_spixel'] = out['spixel']
            ...
            pair_outs['neg_spixel'] = out['spixel']
        else:

...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_root", default='./data', type=str,
                        help="Path to RedtideDataset")

    # Dataset
    parser.add_argument("--img_list", default="train.txt", type=str)
    parser.add_argument("--eval_img_list", default="eval.txt", type=str)
   ...
   # Class Activation Map
    ...
    parser.add_argument("--cam_weight_decay", default=1e-5, type=float)
    ...
    parser.add_argument("--sp_loss_weight", default=1, type=float)
    parser.add_argument("--procam_loss_weight", default=1, type=float)
    ...
    parser.add_argument("--train_procam_pass", type=str2bool, default=True)
    ...
    if args.train_procam_pass is True:
        ...
        timer = pyutils.Timer('step.train_procam_our:')

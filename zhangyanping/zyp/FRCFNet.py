...
#from model.zyp.FSFF_4 import FSFF_4
from model.zyp.MCIF import MCIF
...
class FRCFNet(nn.Module):
    #def __init__(self, band_num=3, class_num=1):

    def __init__(self, band_num, class_num):
        super(FRCFNet, self).__init__()
...
if __name__ == '__main__':
        ...
        model = FRCFNet(band_num=4, class_num=2)
        # 计算模型的总参数量

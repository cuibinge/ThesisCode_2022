...
LoveDA4_CATEGORIES = [
    ...
    {"color": [159, 129, 183], "id": 5, "name": "barren", "trainId": 2},

    {"color": [255, 195, 128], "id": 7, "name": "agriculture", "trainId": 3},
]


def _get_coco_stuff_meta():
    stuff_ids = [k["id"] for k in LoveDA4_CATEGORIES]


    stuff_dataset_id_to_contiguous_id = {k: i for i, k in enumerate(stuff_ids)}
    stuff_classes = [k["name"] for k in LoveDA4_CATEGORIES]
    stuff_color = [k["color"] for k in LoveDA4_CATEGORIES]
...
def register_LoveDA4(root):
    root = os.path.join(root, "LoveDA4")

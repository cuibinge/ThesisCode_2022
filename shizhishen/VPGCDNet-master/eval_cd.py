...
def main():
    ...
    parser.add_argument('--project_name', default='train207', type=str)
    parser.add_argument('--Vis_name', default='vis08', type=str)
    ...
    config = get_config()
    #  checkpoints dir
    args.checkpoint_dir = os.path.join('checkpoints01', args.project_name)
    os.makedirs(args.checkpoint_dir, exist_ok=True)
    #  visualize dir
    args.vis_dir = os.path.join('vis', args.Vis_name)

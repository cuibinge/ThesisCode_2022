...
def test(args):
    from models.evaluator01 import CDEvaluator
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_name', default='LEVIR_train', type=str)
    parser.add_argument('--checkpoint_root', default='checkpoints01', type=str)

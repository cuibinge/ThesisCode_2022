...
from src.utils.misc.metric_tool import ConfuseMatrixMeter
from src.models.losses import cross_entropy
import src.models.losses as losses

from src.utils.misc.logger_tool import Logger, Timer

from src.utils.utils import de_norm
...
class CDTrainer():
    ...
    def __init__(self, args, dataloaders):
        ...
        #                            else "cpu")
        self.device = torch.device("cuda", args.gpu_ids[0]) if torch.cuda.is_available() and len(
            args.gpu_ids) > 0 else torch.device("cpu")
    ...
    def train_models(self):
        ...
        print('***********')
        print(f"Model device: {next(self.net_G.parameters()).device}")

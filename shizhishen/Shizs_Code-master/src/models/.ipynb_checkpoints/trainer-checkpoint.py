...
import utils
from models.networks01 import *

import torch
import torch.optim as optim

from src.utils.src.utils.misc.metric_tool import ConfuseMatrixMeter
...
class CDTrainer():
    ...
    def __init__(self, args, dataloaders):
        ...
        #                            else "cpu")
        self.device = torch.device("cuda", args.gpu_ids[0]) if torch.cuda.is_available() and len(args.gpu_ids) > 0 else torch.device("cpu")

...
class CDDataset(ImageDataset):
    ...
    def __init__(self, root_dir, img_size, split='train', is_train=True, is_Val = False, label_transform=None,
                 to_tensor=True):
    ...
    def __getitem__(self, index):
        if self.is_val:
            list_path = os.path.join(self.root_dir, LIST_FOLDER_NAME,'vis.txt')

...
class ImageDataset(data.Dataset):
    def __init__(self, root_dir, split='train', img_size=256, is_train=True, to_tensor=True):
        ...
        self.augm = CDDataAugmentation(img_size=self.img_size, with_random_hflip=is_train,
                                        with_random_vflip=is_train, with_scale_random_crop=is_train,
                                        with_random_blur=is_train)
...
class CDDataset(ImageDataset):
    def __init__(self, root_dir, img_size, split='train', is_train=True, is_val=False,
                 label_transform=None, to_tensor=True):
